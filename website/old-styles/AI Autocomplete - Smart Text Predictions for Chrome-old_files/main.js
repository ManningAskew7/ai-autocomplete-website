...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typingDemo) {
        const suggestions = [
            'well and we covered all agenda items',
            'better than expected with great results',
            'smoothly despite the technical challenges',
            'productively with actionable outcomes',
            'efficiently and everyone was engaged'
        ];
